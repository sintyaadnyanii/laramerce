            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <div class="intro-x mt-8">
                        <input type="text" id="name" class="intro-x login__input form-control py-3 px-4 block" placeholder="Name">
                        <input type="email" id="email" class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Email">
                        <input type="password" id="password" class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Password">
                        <input type="text" id="phone" class="intro-x login__input form-control py-3 px-4 block" placeholder="Phone">
                        <input type="text" id="address" class="intro-x login__input form-control py-3 px-4 block" placeholder="Address">

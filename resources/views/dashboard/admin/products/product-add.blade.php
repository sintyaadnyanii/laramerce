            ...
            <form action="{{ route('manage_product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="intro-y box p-5">
                    <div>
                        ...
                        @enderror
                        <input id="name" name="name" type="text" class="form-control" placeholder="Input product name" value="{{ old('name') }}">
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <input id="product_code" name="product_code" type="text" class="form-control" placeholder="Input Product Code" value="{{old('product_code')}}">
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <small class="text-xs text-red-500 ml-1">{{ '*' . $message }}</small>
                        @enderror
                        <input id="weight" name="weight" type="text" class="form-control" placeholder="Input Product Weight (gram) ex: 250" value="{{ old('weight') }}">
                    </div>
                    <div class="mt-3">
                        ...
                        <small class="text-xs text-red-500 ml-1">{{ '*' . $message }}</small>
                        @enderror
                        <input id="price" name="price" type="text" class="form-control" placeholder="Input Product Price (Rp)" value="{{ old('price') }}">
                    </div>
                    <div class="mt-3">
                        ...
                        <small class="text-xs text-red-500 ml-1">{{ '*' . $message }}</small>
                        @enderror
                        <input type="number" name="stock" id="stock" class="form-control" placeholder="Input Product Stock" value="{{ old('stock') }}">
                    </div>

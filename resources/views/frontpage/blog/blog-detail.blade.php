                ...
                <aside class="col-md-3 col-sm-4 col-xs-12 content-aside left_column " id="column-left">
                    <div class="module blog-category titleLine">
                        ...
                        <div class="modcontent">
                            <ul class="list-group ">
                                <li class="list-group-item"> <a href="{{ route('blog') }}"class="group-item active">Our Blog</a></li>
                                <li class="list-group-item"><a href="{{ route('blog') }}" class="group-item">Demo Category 2</a></li>
                                <li class="list-group-item"><a href="{{ route('blog') }}" class="group-item">Demo Category 3</a></li>
                                <li class="list-group-item"><a href="{{ route('blog') }}" class="group-item">Demo Category 4</a></li>
                                <li class="list-group-item"><a href="{{ route('blog') }}" class="group-item">Demo Category 5</a></li>
                            </ul>
                ...
                <div id="content" class="col-md-9 col-sm-8">
                    <div class="article-info">
                        ...
                        <div class="form-group">
                            <a href="image/catalog/blog/4.jpg" class="image-popup"><img src="image/catalog/blog/4.jpg" alt="Kire tuma demonstraverunt lector"></a>
                        </div>
